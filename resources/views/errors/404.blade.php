...
<section class="flex items-center h-full sm:p-16 bg-gray-50 text-gray-800">
	<div class="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
		...
		<p class="text-3xl">Uppss..!! halaman yang dicari tidak ada.</p>
		<a rel="noopener noreferrer" href="/" class="px-8 py-3 font-semibold rounded bg-violet-600 text-gray-50">Back to homepage</a>
	</div>
</section>
@endsection
